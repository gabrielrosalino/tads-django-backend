# Generated by Django 5.2.1 on 2025-06-14 03:28
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "estado_civil",
                    models.CharField(
                        blank=True, max_length=20, verbose_name="Estado Civil"
                    ),
                ),
                (
                    "nome_pai",
                ...
                (
                    "escolaridade_pai",
                    models.CharField(
                        blank=True, max_length=50, verbose_name="Escolaridade do Pai"
                    ),
                ),
                (
                    "nome_mae",
                ...
                (
                    "escolaridade_mae",
                    models.CharField(
                        blank=True, max_length=50, verbose_name="Escolaridade da Mãe"
                    ),
                ),
                (
                    "renda_familiar",
                ...
                (
                    "cursos_interesse",
                    models.JSONField(
                        blank=True, null=True, verbose_name="Cursos de Interesse"
                    ),
                ),
                (
                    "periodos",
                    models.JSONField(blank=True, null=True, verbose_name="Períodos"),
                ),
            ],
        ),
        migrations.CreateModel(
